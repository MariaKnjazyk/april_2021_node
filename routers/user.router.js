...
router.post('/', userMiddleware.isFillInAllFields, userMiddleware.checkUniqueEmail, userController.createUser);
...
router.put('/:userId', userMiddleware.checkDataToModify,
